...
// ---------------------------------------------------------------------------
    ...
    // $dragging is only a variable, could be $apple or $foobar
    var $dragging = null;

    // make the dragging happen as the mouse moves 
